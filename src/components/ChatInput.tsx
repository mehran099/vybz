      ...
      <div className="flex gap-2 items-center">
        <div className="flex-1 relative">
          <Input
            ...
            className="pr-10 bg-input border-border focus:ring-2 focus:ring-primary"
            maxLength={500}
          />
          <Button
            type="button"
        ...
        <Button
          ...
          className="bg-gradient-to-r from-primary to-secondary hover:opacity-90 text-primary-foreground shadow-lg hover:shadow-glow"
        >
